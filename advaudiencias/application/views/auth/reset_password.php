                    ...
                    <div class="form-box">
                        ...
                        <?php echo form_open(base_url('auth/reset_password/'.$reset_code), 'class="login-form" '); ?>
                            <div class="input-group">
                                ...
                                <input type="password" name="confirm_password" id="confirm_password" class="form-control" placeholder="Confirmar Senha" >
                                <div class="row">
                              </div>
                                <input type="submit" name="submit" id="submit" class="form-control" value="Salvar">
                            </div>
                        <?php echo form_close(); ?>
                    </div>
                </div>
