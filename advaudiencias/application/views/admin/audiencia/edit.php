  ...
  <div class="row">
    <div class="col-md-12">
      <div class="box box-body with-border">
        <div class="col-md-6">
          <h4><i class="fa fa-plus"></i> &nbsp; Editar Audiência</h4>
        </div>
            ...
            <?php echo form_open(base_url('admin/audiencia/edit/'.$audiencia['codigo'] ), 'class="form-horizontal"' );  ?> 
              ...
              <div class="form-group">
                ...
                <div class="col-lg-4">
                  <div class="input-group date ">
                    ...
                    <?php
                      $date=date_create($audiencia['data']);
                    ?>
                    <input value="<?= date_format($date,"d/m/Y"); ?>" type="text" name="data" class="form-control pull-right" id="datepicker">
                    <!-- /input-group -->
                  </div>
                </div>
                <!-- /.col-lg-6 -->
                ...
                <div class="col-lg-3">
                  ...
                  <input value="<?= $audiencia['hora'] ?>"  type="text" name="hora" class="form-control" id="hora" placeholder="">
                  </div>
                  <!-- /input-group -->
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-lg-4">
                  ...
                  <div class="input-group">
                    <input value="<?= $audiencia['processo']; ?>" name="processo" type="text" class="form-control">
                  </div>
                  <!-- /input-group -->
                </div>
                <!-- /.col-lg-6 -->
                ...
                <div class="col-lg-3">
                  <div class="input-group">
                    <input value="<?= $audiencia['grupo_cota']; ?>"  name="grupo_cota" type="text" class="form-control">
                  </div>
                  <!-- /input-group -->
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <select name="tipo_audiencia" class="form-control select2" id="tipo_audiencia" data-placeholder="Selecione" style="width: 100%;">
                  <option <?= $audiencia['tipo_audiencia'] == '1' ? "selected" : "" ?> value="1">Justiça Comum</option>
                  <option <?= $audiencia['tipo_audiencia'] == '2' ? "selected" : "" ?> value="2">Advogado + Preposto</option>
                  <option <?= $audiencia['tipo_audiencia'] == '3' ? "selected" : "" ?> value="3">Presposto</option>
                  <option <?= $audiencia['tipo_audiencia'] == '4' ? "selected" : "" ?> value="4">Procon</option>
                  <option <?= $audiencia['tipo_audiencia'] == '5' ? "selected" : "" ?> value="5">Trabalhista</option>
                  <option <?= $audiencia['tipo_audiencia'] == '6' ? "selected" : "" ?> value="6">Outros</option>
                </select>
                </div>
              </div> 
              ...
              <div class="form-group">
                  ...
                  <div class="col-sm-9">
                  <input value="<?= $audiencia['parte_1']; ?>" type="text" name="parte_1" class="form-control" id="parte_1" placeholder="">
                  </div>
              </div>
              ...
              <div class="form-group">
                  ...
                  <div class="col-sm-9">
                  <input value="<?= $audiencia['parte_2']; ?>" type="text" name="parte_2" class="form-control" id="parte_2" placeholder="">
                  </div>
              </div>
              ...
              <div class="form-group">
                  ...
                  <div class="col-sm-9">
                  <input value="<?= $audiencia['adv_escritorio']; ?>" type="text" name="adv_escritorio" class="form-control" id="adv_escritorio" placeholder="">
                  </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="box-body pad col-sm-9">
                    <textarea  name="observacoes" rows="4" class="textarea" placeholder="Digite aqui as observações desta audiência..." 
                    style="width: 100%; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?= $audiencia['observacoes']; ?></textarea>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <select name="status" class="form-control select2" id="status" data-placeholder="Selecione" style="width: 100%;">
                  <option <?= $audiencia['status'] == '1' ? "selected" : "" ?> value="1">Audiência Cadastrada</option>
                  <option <?= $audiencia['status'] == '2' ? "selected" : "" ?> value="2">Advogado Confirmado</option>
                  <option <?= $audiencia['status'] == '3' ? "selected" : "" ?> value="3">Defesa Elaborada</option>
                  <option <?= $audiencia['status'] == '4' ? "selected" : "" ?> value="4">Protocolado</option>
                  <option <?= $audiencia['status'] == '5' ? "selected" : "" ?> value="5">Enviado Correspondente</option>
                  <option <?= $audiencia['status'] == '6' ? "selected" : "" ?> value="6">Ata Recebida</option>
                  <option <?= $audiencia['status'] == '7' ? "selected" : "" ?> value="7">Pago</option>
                  <option <?= $audiencia['status'] == '8' ? "selected" : "" ?>value="8">Arquivado</option>
                </select>
                </div>
              </div>
