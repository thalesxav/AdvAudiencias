  ...
  <div class="row">
    <div class="col-md-12">
      <div class="box box-body">
        <div class="col-md-6">
          <h4><i class="fa fa-pencil"></i> &nbsp; Alterar Senha</h4>
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="box">
        ...
        <div class="box-body my-form-body">
          <?php if(validation_errors() !== ''): ?>
            ...
            <?php echo form_open(base_url('admin/admin/change_pwd/'.$admin['admin_id']), 'class="form-horizontal"');  ?> 
              ...
              <div class="form-group">
                <div class="col-md-11">
                  <input type="submit" name="submit" value="Alterar" class="btn btn-info pull-right">
                </div>
              </div>
            <?php echo form_close( ); ?>
          </div>
