  ...
  <div class="row">
    <div class="col-md-12">
      <div class="box box-body with-border">
        <div class="col-md-6">
          <h4><i class="fa fa-plus"></i> &nbsp; Editar Advogado</h4>
        </div>
      ...
      <div class="box">
        ...
        <div class="box-body my-form-body">
          <?php if(isset($msg) || validation_errors() !== ''): ?>
            ...
            <?php echo form_open(base_url('admin/advogado/edit/'.$advogado['codigo_advogado'] ), 'class="form-horizontal"' );  ?> 
              <div class="form-group">
                <label for="codigo" class="col-sm-2 control-label">Código</label>

                <div class="col-sm-9">
                  <input readonly value="<?= $advogado['codigo_advogado'] ?>" type="text" name="codigo" class="form-control" id="codigo" placeholder="">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <input  value="<?= $advogado['nome'] ?>" type="text" name="nome" class="form-control" id="nome" placeholder="">
                </div>
              </div>
              ...
              <label for="numero_oab" class="col-sm-2 control-label">Número OAB</label>
                <div class="col-lg-4">
                  ...
                  <input type="text" value="<?= $advogado['numero_oab'] ?>" name="numero_oab" class="form-control" id="numero_oab" placeholder="">
                  </div>
                  <!-- /input-group -->
                </div>
                <!-- /.col-lg-6 -->
                ...
                <div class="col-lg-3">
                  <div class="input-group">
                  <input type="text" value="<?= $advogado['cpf'] ?>" name="cpf" class="form-control" id="cpf" placeholder="">
                  </div>
                  <!-- /input-group -->
                </div>
              </div>
              ...
              <div class="form-group">
                  ...
                  <div class="col-sm-9">
                  <input type="text" value="<?= $advogado['email'] ?>" name="email" class="form-control" id="email" placeholder="">
                  </div>
              </div>
              ...
              <div class="form-group">
                  ...
                  <div class="col-sm-4">
                  <input type="text" value="<?= $advogado['telefone'] ?>" name="telefone" class="form-control" id="telefone" placeholder="">
                  </div>
              </div>
                ...
                <div class="col-sm-9">
                  <select class="form-control select2" name="banco" style="width: 100%;">
                    <?php foreach($bancos as $role): ?>
                      <option <?= $advogado['banco'] == $role['cod'] ? "selected" : "" ?> value="<?= $role['cod']; ?>"><?= $role['banco']; ?></option>
                    <?php endforeach; ?>
                  </select>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-lg-4">
                  ...
                  <div class="input-group">
                    <input value="<?= $advogado['agencia'] ?>" name="agencia" type="text" class="form-control">
                  </div>
                  <!-- /input-group -->
                </div>
                <!-- /.col-lg-6 -->
                ...
                <div class="col-lg-3">
                  <div class="input-group">
                    <input value="<?= $advogado['conta'] ?>" name="conta" type="text" class="form-control">
                  </div>
                  <!-- /input-group -->
                </div>
              </div>
              ...
              //var_dump($advogado['comarcas_ids']);
                ...
                <div class="col-sm-9">
                  <select name="comarcas[]" class="form-control select2" id="comarcas" multiple="multiple" data-placeholder="Selecione" style="width: 100%;">
                    <?php foreach($comarcas as $role): ?>
                      <?php if (in_array($role['codigo'], $advogado['comarcas_ids'])): ?>
                        <option selected value="<?= $role['codigo']; ?>"><?= $role['estado']; ?> - <?= $role['comarca']; ?></option>
                      <?php else: ?>
              ...
              <div class="form-group">
                ...
                <div class="col-lg-4">
                  ...
                  <div class="input-group">
                    <input value="<?= $advogado['vlr_justica_comum'] ?>" name="vlr_justica_comum" type="text" class="form-control">
                  </div>
                  <!-- /input-group -->
                </div>
                <!-- /.col-lg-6 -->
                ...
                <div class="col-lg-3">
                  <div class="input-group">
                    <input value="<?= $advogado['vlr_adv_preposto'] ?>" name="vlr_adv_preposto" type="text" class="form-control">
                  </div>
                  <!-- /input-group -->
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-lg-4">
                  ...
                  <div class="input-group">
                    <input value="<?= $advogado['vlr_preposto'] ?>" name="vlr_preposto" type="text" class="form-control">
                  </div>
                  <!-- /input-group -->
                </div>
                <!-- /.col-lg-6 -->
                ...
                <div class="col-lg-3">
                  <div class="input-group">
                    <input value="<?= $advogado['vlr_procon'] ?>" name="vlr_procon" type="text" class="form-control">
                  </div>
                  <!-- /input-group -->
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-lg-4">
                  ...
                  <div class="input-group">
                    <input value="<?= $advogado['vlr_trabalhista'] ?>" name="vlr_trabalhista" type="text" class="form-control">
                  </div>
                  <!-- /input-group -->
                </div>
                <!-- /.col-lg-6 -->
                ...
                <div class="col-lg-3">
                  <div class="input-group">
                    <input value="<?= $advogado['vlr_outros'] ?>" name="vlr_outros" type="text" class="form-control">
                  </div>
                  <!-- /input-group -->
                </div>
              </div>
