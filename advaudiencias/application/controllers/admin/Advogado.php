...
class Advogado extends CI_Controller
{
	...
	function add()
	{
		...
		if($this->input->post('submit')){
				...
				if ($this->form_validation->run() == FALSE) {
					...
					if($result){
						$this->session->set_flashdata('msg', 'Usuแrio adicionado com sucesso!');
	...
	function edit($id="")
	{
		...
		if($this->input->post('submit')){
			...
			$this->form_validation->set_rules('username', 'Usuรกrio', 'trim|required');
			//$this->form_validation->set_rules('firstname', 'Firstname', 'trim|required');
			//$this->form_validation->set_rules('lastname', 'Lastname', 'trim|required');
			...
			if ($this->form_validation->run() == FALSE) {
				...
				if($result){
					$this->session->set_flashdata('msg', 'Usuรกrio atualizado com sucesso!');
					redirect(base_url('admin/admin'));
				}
			}
		}
	...
	function delete($id='')
	{
		...
		$this->session->set_flashdata('success','Usuแrio deletado com sucesso.');
		redirect('admin/admin');
	}
