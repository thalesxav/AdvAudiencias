...
--
-- Host: 127.0.0.1:3306
-- Generation Time: 01-Ago-2019 às 19:55
...
CREATE TABLE IF NOT EXISTS `advogados` (
  ...
  PRIMARY KEY (`codigo`),
  KEY `FK_COMARCAS` (`codigo_comarca`)
...
CREATE TABLE IF NOT EXISTS `audiencias` (
  ...
  `adv_escritório` varchar(255) NOT NULL,
...
--
-- Limitadores para a tabela `advogados`
--
ALTER TABLE `advogados`
  ADD CONSTRAINT `FK_COMARCAS` FOREIGN KEY (`codigo_comarca`) REFERENCES `comarcas` (`codigo`);
